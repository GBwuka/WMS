...
KEditor.prototype = {
	...
	readonly : function(isReadonly) {
		...
		if (self.designMode) {
			self.toolbar.disableAll(isReadonly, ['preview']);
		} else {
			...
			yesBtn : {
				...
				click : function(e) {
					...
					if (K.trim(title) === '') {
						...
						title = url_list[url_list.length-1];
					}
...
KindEditor.plugin('preview', function(K) {
	...
	self.clickToolbar(name, function() {
		var lang = self.lang(name + '.'),
			html = '<div style="padding:10px 20px;">' +
				'<iframe class="ke-textarea" frameborder="0" style="width:1408px;height:800px;"></iframe>' +
				'</div>',
			dialog = self.createDialog({
				name : name,
				width : 1450,
